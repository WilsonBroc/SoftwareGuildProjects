...
namespace SGBank.BLL
{
    public class AccountManager
    {
        ...
        public Response<TransactionReciept> Deposit(decimal amount, Account account)
        {
            var response = new Response<TransactionReciept>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    response.Data = new TransactionReciept();
                    response.Data.AccountNumber = account.AccountNumber;
                    response.Data.TransactionAmount = amount;
        ...
        public Response<TransactionReciept> Withdraw(decimal amount, Account account)
        {
            var response = new Response<TransactionReciept>();
            ...
            try
            {
                ...
                {
                    response.Success = false;
                    response.Message = "You do not have the available funds for this withdrawal.";
                }
                else
                {
                    account.Balance -= amount;
